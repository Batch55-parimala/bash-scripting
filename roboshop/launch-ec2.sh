...
COMPONENT=$1 
ENV=$2
HOSTEDZONEID="Z02308013R19EM36500WS"
...
SG_ID="$(aws ec2 describe-security-groups  --filters Name=group-name,Values=B55_Allow all | jq '.SecurityGroups[].GroupId' | sed -e 's/"//g')"       # b54-allow-all security group id
